...
#se non voglio specificare il campo data uso lm(vend$vendite~vend$ttrend)
summary(det.mod)
...
plot(vend$detvendite, type="l", col="blue")
...
summary(unimod)
unires <- resid(unimod)
lines(unires, col="blue", lty=2)
#NB: potevo usare plot...ha usato lines così si vedo che il grafico praticamente coincide col precedente
